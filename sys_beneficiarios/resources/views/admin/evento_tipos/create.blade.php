<x-app-layout>
    <x-slot name="header"><h2 class="h4 m-0">Nuevo tipo de evento</h2></x-slot>

    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.evento-tipos.store') }}" novalidate>
                @csrf

                @include('admin.evento_tipos.partials.form')
