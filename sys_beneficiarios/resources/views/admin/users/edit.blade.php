<x-app-layout>
    ...
    @php($hasOldMunicipios = session()->hasOldInput('municipio_ids'))
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route($userRoutes.'.update', $user) }}" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Dejala vacia para conservar la actual.</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="oficina_id" name="oficina_id" class="form-select @error('oficina_id') is-invalid @enderror">
                            ...
                            @foreach($offices as $office)
                                <option value="{{ $office->id }}" data-region="{{ $office->region }}" @selected((string) old('oficina_id', $user->oficina_id) === (string) $office->id)>
                                    {{ $office->nombre }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between gap-2 mb-3">
                                <div>
                                    ...
                                    <div class="small text-muted">Marca o desmarca municipios antes de guardar.</div>
                                </div>
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-cta"><i class="bi bi-save me-1"></i>Actualizar usuario</button>
                </div>
            </form>
        </div>
    </div>
